...
class TestFakeWeb < Test::Unit::TestCase
  ...
  def test_register_uri_with_block
    FakeWeb.register_uri(:any, 'http://mock/test_example.txt', {}) { 'foo' }
    assert FakeWeb.registered_uri?(:any, 'http://mock/test_example.txt')
  end
  ...
  def test_content_for_registered_uri_with_block
    FakeWeb.register_uri(:any, 'http://example.com:3000/', {}) { |params| 'test example content' }
